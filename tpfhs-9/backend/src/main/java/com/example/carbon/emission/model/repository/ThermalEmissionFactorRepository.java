...
@Repository
public interface ThermalEmissionFactorRepository extends JpaRepository<ThermalEmissionFactor, Long> {

    Optional<ThermalEmissionFactor> findByEmissionFactorName(String emissionFactorName);
