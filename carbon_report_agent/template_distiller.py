...
def load_template_package(path: str | Path | None = None) -> TemplatePackage:
    ...
    if not package_path.exists():
        return TemplatePackage(
            source_path="bundled-shuohuang-template",
            section_titles=[
                "第一章 报告主体基本情况",
                "第二章 温室气体排放情况",
                "第三章 活动水平数据及来源说明",
            ...
            table_count=12,
            table_roles=[
                "approval", "equipment", "workload_monthly", "emission_sources",
                "emission_summary", "monitoring", "appendix_emission_summary",
                "appendix_fuel", "appendix_electricity", "appendix_heat",
            ],
            wording_snippets={
