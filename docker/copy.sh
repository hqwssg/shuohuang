...
cp "../tpfhs-8-0616（删除焓值）/backend/target/carbon-emission-model-1.0.0.jar" ./web-main/jar/carbon-emission-model.jar
cp -r "../tpfhs-8-0616（删除焓值）/frontend/dist/." ./web-main/html/carbon-model/
cp "../tpfhs-8-0616（删除焓值）/backend/steam_calculator.py" ./web-main/python/steam_calculator.py
